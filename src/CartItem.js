        ...
        <div className='cart-item'>
            ...
            <div className='right-block'>
                ...
                <div className="cart-item-actions">
                    {/* Buttons */}
                    <img style={styles.actionIcons} alt="increase" className="action-items" src="https://cdn-icons-png.flaticon.com/512/992/992651.png" />
                    <img style={styles.actionIcons} alt="decrease" className="action-items" src="https://cdn-icons-png.flaticon.com/512/992/992683.png" />
                    <img style={styles.actionIcons} alt="delete" className="action-items" src="https://cdn-icons-png.flaticon.com/512/6861/6861362.png" />
